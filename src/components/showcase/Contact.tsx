...
import MyResumeFile from '../assets/resume/Resume.pdf';
...
const Contact: React.FC<ContactProps> = (props) => {
    ...
    async function submitForm() {
        ...
        try {
            ...
            const res = await fetch(
                'https://api.bryanparreira.com/api/contact',
                {
                    method: 'POST',
                    headers: {
        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/bryanparreira'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://www.linkedin.com/in/bryan-bernardo-parreira/'}
                    />
                    <SocialBox
                        icon={twitterIcon}
                        link={'https://twitter.com/bryanparreira03'}
                    />
                </div>
            </div>
    ...
    <a href={MyResumeFile} download="Bryan_Parreira_Resume.pdf" style={{color: colors.blue}}>
