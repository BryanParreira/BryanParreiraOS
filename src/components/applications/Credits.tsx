...
const CREDITS = [
    {
        ...
        rows: [['Bryan Bernardo Parreira', 'All']],
    },
    {
    ...
    },
    {
        title: 'Sound Design',
        rows: [
            ['Bryan Bernardo Parreira', 'Mixing, Composition, & Foley'],
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2025 Bryan Bernardo Parreira'}
        >
            <div
